...
class CollectionsAnnotationProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val idClassList = resolver
            ...
            .getSymbolsWithAnnotation("dev.vihang.firestore4k.typed.IdOf")
        ...
        val collectionClassList = resolver
            // Getting all symbols that are annotated with @Entity.
            .getSymbolsWithAnnotation("dev.vihang.firestore4k.typed.Collection")
            // Making sure we take only class declarations.
            .filterIsInstance<KSClassDeclaration>()
            .filter { it.classKind == ClassKind.CLASS }
            .map {
    ...
    companion object {
        const val DSL_MODEL_PACKAGE_NAME = "dev.vihang.firestore4k.typed"
    }
}
